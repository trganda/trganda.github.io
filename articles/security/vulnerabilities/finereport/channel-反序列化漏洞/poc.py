...
def cmd(host):
  try:
    ...
    headers = {"Content-Type": "application/octet-stream", "token": "eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJmYW5ydWFuIiwiaWF0IjoxNjkxODIyNTMwLCJzdWIiOiJ0cmdhbmRhIiwianRpIjoiZXhCUCtvT3MzejZwbDRzcFNIVmRBOEdiYWxDbHdTRDdWOTR3OGNvelN0MVFDUURUIn0.ELHg317nr3ipYkb90dpnnXQ73cZwUa3fAnjOmSlU2wo", "username": "trganda"}
